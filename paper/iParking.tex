...
\begin{figure}[tbp]
  ...
  \subfigure[Gray scale image] {
		\includegraphics[scale=0.9,natwidth=401,natheight=214]{Figures/grayScaleImage.png}
    \label{fig:grayScale}
  }
	\hspace{0.1in}
	\subfigure[ROI image] {
		\includegraphics[scale=0.9,natwidth=405,natheight=216]{Figures/ROIImage.png}
    \label{fig:ROI}
  }
