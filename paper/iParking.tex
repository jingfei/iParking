...
It is shown that the difference between supply and demand
...
\begin{figure}[tbp]
	\subfigure[Available parking space] {
		\includegraphics[scale=0.7,natwidth=421,natheight=266]{Figures/availableParkingSpace.png}
	}
	\hspace{0.5in}
	\subfigure[Unavailable parking space] {
		\includegraphics[scale=0.7,natwidth=421,natheight=266]{Figures/unavailableParkingSpace.png}
	}
